...
from data_ms.federated_search.tools import search_potential_match_issues
...
mcp.add_tool(Tool.from_function(search_potential_match_issues, name="search_potential_match_issues"))
